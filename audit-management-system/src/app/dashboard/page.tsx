export default function DashboardPage() {
  return (
    <div className="w-full bg-background text-foreground min-h-full flex flex-col items-center justify-content-center px-20 py-12">
      <div className="w-full flex flex-wrap items-center justify-between gap-4 mb-5">
      ...
      <div className="rounded-2xl border border-border bg-background/80 overflow-hidden w-full h-full">
        ...
        <div className="bg-background border-t border-border/80 flex items-center justify-center text-md h-full">
